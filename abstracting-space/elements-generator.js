/* 
This: fixed inset-0 flex items-center justify-center z-50 .. creates the dialog container to be a continuoum of the page. nice, can be scrolled if needed. just need to make sure it positions well .. good for phone screens mainly, but also can be good for desktop if page is scrolled down.
*/
...
function createDivWithContent(divId, divStyle, contentFunctions) { // generates a div with inner html content generated by the functions passed in the contentFunctions array
  let divId = "div-id";
  let divStyle =
